  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="mt-4">
          {/* 提示信息框 */}
          <div className="bg-indigo-100 rounded-lg p-3 sm:p-4 text-sm sm:text-lg mb-6">
          ...
          <div className="space-y-3 mb-6">
            ...
            <button
              ...
              className="w-full bg-slate-100 hover:bg-slate-200 rounded-lg p-3 sm:p-4 flex items-center justify-between transition-colors cursor-pointer"
            >
              <div className="flex items-center gap-3">
                <LayoutGrid className="w-4 h-4 sm:w-5 sm:h-5 text-slate-700" />
                <span className="text-slate-900 text-sm sm:text-lg">返回所有课程</span>
              </div>
            ...
            {showBackToCourseDetail && onBackToCourseDetail && (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-slate-900 text-sm sm:text-lg">返回当前课程</span>
                </div>
                <ChevronLeft className="w-5 h-5 text-slate-700 rotate-180" />
              </button>
            )}
          ...
          <button
            onClick={onContinue}
            className="w-full bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg p-3 sm:p-4 flex items-center justify-center gap-2 transition-colors font-medium cursor-pointer"
          >
            <Play className="w-4 h-4 sm:w-5 sm:h-5" />
            <span className='text-sm sm:text-lg'>继续学习</span>
          </button>
        </div>
      </DialogContent>
    </Dialog>
