        ...
        <Table>
          <TableHeader>
            <TableRow className="dark:border-slate-700 dark:hover:bg-slate-800/50">
              <TableHead className="dark:text-slate-400">单词</TableHead>
              <TableHead className="dark:text-slate-400 w-[200px]">翻译</TableHead>
              <TableHead className="dark:text-slate-400">分类</TableHead>
          ...
          <TableBody>
            {records.length === 0 ? (
              <TableRow>
                <TableCell colSpan={8} className="text-center dark:text-slate-400">
                  <Empty text="暂无记录" />
                </TableCell>
              </TableRow>
            ) : (
              records.map((record, index) => (
                <TableRow key={record.id} className={cn(
                  ...
                  <TableCell className="dark:text-slate-300">{record.word.word}</TableCell>
                  <TableCell>
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger>
                          <div className="truncate max-w-[200px] dark:text-slate-300">
