...
export default function VideoPage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] -mt-14">
            ...
            <p className="text-2xl md:text-4xl text-slate-800 dark:text-slate-100 mt-8">看视频学英语，4月即将上线</p>
            <p className="text-3xl md:text-4xl text-slate-800 mt-4 font-extralight dark:text-slate-100">Coming Soon~</p>
        </div>
    )
}
